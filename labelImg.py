...
class MainWindow(QMainWindow, WindowMixin):
    ...
    def __init__(self, defaultFilename=None, defaultPrefdefClassFile=None):
        ...
        Segment_Roi = action('&Optimize\nPolygon', self.Segment_Roi,#.............................................................
                      'f', 'color', u'Segment',enabled=False)

        ploygon = action('&Create\nPloygon', self.SetPloygon,#.............................................................
                'q', 'edit', u'polygon',enabled=False)
        ...
        self.actions = struct(save=save, saveAs=saveAs, open=open, close=close,
                              ...
                              create=create, ploygon = ploygon, Segment_Roi=Segment_Roi,delete=delete, edit=edit, copy=copy,
                              ...
                              editMenu=(edit, copy, delete,
                                        None, color1, color2),
                              beginnerContext=(create,ploygon,Segment_Roi, edit, copy, delete),
                              advancedContext=(createMode, editMode, edit, copy,
                                               delete, shapeLineColor, shapeFillColor),
                              onLoadActive=(
                                  close, create,ploygon, Segment_Roi,createMode, editMode),
        ...
        self.actions.beginner = (
            open, opendir, openNextImg, openPrevImg, verify, save, None, create,ploygon, Segment_Roi,copy, delete, changeSavedir, None,
            zoomIn, zoom, zoomOut, fitWindow, fitWidth)

        self.actions.advanced = (
            open, opendir, changeSavedir, openNextImg, openPrevImg, save, None,
            createMode,ploygon, Segment_Roi, editMode, None,
            hideAll, showAll)
    ...
    def populateModeActions(self): #先进入这一个模式
        if self.beginner():
    ...
    def SetPloygon(self):
        ...
        self.canvas.setPolygon( self.actions,self.filePath, True)
        self.actions.ploygon.setEnabled(True)
        self.actions.editMode.setEnabled(False)
    ...
    def Segment_Roi(self):
        ...
        #     self.remLabel(self.canvas.shapes[len(self.canvas.shapes)-2])
        #     if self.fg and self.bg:
        #         self.remLabel(self.canvas.shapes[len(self.canvas.shapes)-3])
        self.remLabel(self.canvas.shapes[len(self.canvas.shapes)-1])
        # self.actions.Segment_Roi.setEnabled(True)
        self.flag_enter_seg = True
        self.canvas.Segment_Roi()
    ...
    def saveLabels(self, annotationFilePath):
        ...
        for i in range(len(shapes)): 
            ...
            for p in shapes[i]['points']:
                ...
                xmax = int(max(x, xmax))
                ymax = int(max(y, ymax))
            crop_img = self.image_for_ROI[ ymin:ymax,xmin:xmax ]
            imgFileDir_pic = os.path.dirname(annotationFilePath)
            imgFileName_pic = os.path.basename(self.filePath)
            savedFileName_pic = 'ROI_' + os.path.splitext(imgFileName_pic)[0] + '_' + str(i) + '.jpg'
            savedPath = os.path.join(imgFileDir_pic, savedFileName_pic)
            cv2.imwrite(savedPath ,crop_img)
    ...
    def loadFile(self, filePath=None):
        ...
        if unicodeFilePath and os.path.exists(unicodeFilePath):
            ...
            self.image_for_ROI = cv2.imread(unicodeFilePath)
            if image.isNull():
                self.errorMessage(u'Error opening file',
